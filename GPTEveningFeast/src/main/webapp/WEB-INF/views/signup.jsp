...
<body>
	<div id="wrap" class="member joinmain">
		<!-- header// -->
		<div class="top-area">
			<div class="inner">
				...
				<div class="innercon">
					...
					<div class="linearea">
						<section class="member">
							<img id="logo" src="https://tohome.thehyundai.com/UIUX/w/pjtCom/images/temp/header_logo_freex34.png">
							<strong>코사식품관 일반회원</strong>
							<p class="txt">
